...
alter trigger users_set_updated_at on public.profiles rename to profiles_set_updated_at;
alter trigger contents_set_updated_at on public.educational_content rename to educational_content_set_updated_at;
